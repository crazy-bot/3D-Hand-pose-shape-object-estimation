...
parser.add_argument('--handout', type=str, default='hand_pvsnet_{}.json'.format(validset), help='File to save the predictions.')
parser.add_argument('--objout', type=str, default='obj_pvsnet_{}.json'.format(validset), help='File to save the predictions.')
...
pvsnet.load_state_dict(torch.load(study2_ckpt)['model_state_dict'])
