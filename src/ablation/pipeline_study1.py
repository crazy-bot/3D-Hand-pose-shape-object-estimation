...
parser.add_argument('--handout', type=str, default='pip_hand_snetv2_{}.json'.format(validset), help='File to save the predictions.')
parser.add_argument('--objout', type=str, default='pip_obj_snetv2_{}.json'.format(validset), help='File to save the predictions.')
...
shapenet_weights = torch.load(SNet_v2_ckpt)['model_state_dict']
...
print('==> Constructing model ..HO_ShapeNet_v2')
...
############### savefig dir ###########
if (args.figMode != ''):
    saveFolder = SAVEFIG_DIR + '/pipSNet_v2/'
