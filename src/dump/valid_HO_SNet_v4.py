...
from dataset.HO_Data.HO_shape_v4 import *
...
snetv4 = HO_ShapeNet(input_channels=1, hand_channels=no_handverts, obj_channels=no_objverts)
if(args.multi_GPU):
    snetv4 = torch.nn.DataParallel(snetv4)
snetv4 = snetv4.to(device, dtype)
snetv4.load_state_dict(torch.load(SNet_v4_ckpt)['model_state_dict'])
...
############### savefig dir ###########
if (args.figMode != ''):
    saveFolder = SAVEFIG_DIR + '/SNet_v4/'
