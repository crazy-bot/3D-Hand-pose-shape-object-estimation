...
from src.train_helper import val_HO_PNet
from networks.HO_Nets.HO_Posenet import HO_Posenet
from dataset.HO_Data.HO_pose import Ho3DDataset

ap = argparse.ArgumentParser()
ap.add_argument("--load_ckpt", type=str, help="relative path to load checkpoint", default='HO_PNet/epoch48.pth')
ap.add_argument("--save_ckpt", type=str, help="relative path to save checkpoint", default='HO_PNet_Re')
