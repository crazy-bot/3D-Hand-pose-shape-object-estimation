...
from src.train_helper import train_HO_SNet_v1, val_HO_SNet_v1
from networks.HO_Nets.HO_ShapeNet import HO_ShapeNet
from dataset.HO_Data.HO_shape_v1 import Ho3DDataset


ap = argparse.ArgumentParser()
ap.add_argument("--load_ckpt", type=str, help="relative path to load checkpoint", default='')
ap.add_argument("--save_ckpt", type=str, help="relative path to save checkpoint", default='HO_SNet_v1')
