...
SNet_v4_ckpt = CHECKPOINT_BASE + '/HO_SNet_v4/epoch44.pth'
SNet_v5_ckpt = CHECKPOINT_BASE + '/HO_SNet_v5/epoch37.pth'
SNet_v6_ckpt = CHECKPOINT_BASE + '/HO_SNet_v6/epoch54.pth'
VNet_ckpt = CHECKPOINT_BASE + '/HO_VNet/epoch37.pth'
PVNet_ckpt = CHECKPOINT_BASE + '/HO_PVNet/epoch14.pth'
PSNet_ckpt = CHECKPOINT_BASE + '/HO_PSNet/epoch15.pth'
PVSNet_ckpt = CHECKPOINT_BASE + '/HO_PVSNet/epoch17.pth'
PVSNet_v6_ckpt = CHECKPOINT_BASE + '/HO_PVSNet_v6/epoch9.pth'

############## Evaluation file config {evalset can be 'valid','evaluation'} ###########
evalset = 'valid'
objJson_file = 'pip_obj_PSNetv2_valid.json'
